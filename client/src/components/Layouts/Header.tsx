            ...
            <div className="shadow-sm">
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        ...
                        {themeConfig.isDarkMode ? (<img className="w-8 ml-[5px] flex-none" src="/assets/images/auth/LogoWhite.png" alt="logo" />) : (
                                <img className="w-8 ml-[5px] flex-none" src="/assets/images/auth/Agastra Logo.svg" alt="logo" />
                            )}
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">AGASTRA</span>
                        </Link>
                        <button
                            type="button"
                            ...
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    ...
                                    <li className="border-t border-white-light dark:border-white-light/10" onClick={handleSignout}>
                                        <div className="flex text-danger !py-3 px-4 cursor-pointer">
